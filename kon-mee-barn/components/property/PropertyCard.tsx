...
import { Heart, MapPin, Bed, Bath, Square, GitCompareArrows } from "lucide-react";
          ...
          {showFavorite && (
            <div className="absolute top-3 right-3 flex items-center gap-1.5">
              <button
                ...
                className={`p-2 rounded-full shadow transition-colors ${inCompare ? "bg-primary text-primary-foreground" : "bg-white/90 text-gray-400 hover:bg-white hover:text-primary"}`}
              >
